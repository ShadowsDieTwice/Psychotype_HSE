...
namespace Psychotype_HSE.Models.Components
{
    public class User : Client
    {
        ...
        public char MB_IE()
        {
            double[] weights = { -0.20760827, -0.07135797, -0.21874391, -0.40388973, -0.16355935,
       -0.27051003, -0.01950142, -0.18646525,  0.13481103,  0.11483201,
        ...
        public char MB_SN()
        {
            ...
            double[] weights = {-0.02468234,  0.15876401,  0.00579   ,  0.1070706 , -0.10083021,
       ...
       -0.17497432, -0.15059215 };
        ...
        {
            //Веса  - взяты из линейной модели. Последний элемент - свободный член.
            double[] weights = { -0.12601739,  0.05884192, -0.19327059, -0.06606932, -0.17279054,
       ...
       -0.19280001, -0.04398638, 0.09505607 };
        ...
        public char MB_JP()
        {
            ...
            double[] weights = { 0.17529813,  0.37443151,  0.16527531, -0.38677119,  0.12411282, -0.12357333, -0.16544805,  0.121947  ,  0.02655503,  0.17872141, 0.18261538,  0.13771823,  0.28387095,  0.0497508 , -0.07209034,  -0.0931934 , -0.04085194, 0.00224221 };
